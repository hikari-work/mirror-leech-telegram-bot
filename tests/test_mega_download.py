...
def test_proxied_url_format(mega_dl):
    ...
    assert mega_dl.proxied_url(cdn, 0).startswith("https://p1.com/?url=")
    assert mega_dl.proxied_url(cdn, 1).startswith("https://p2.com/?url=")
